...
{#if $page.data.session?.user }
  <div class="flex items-center">
    <button type="button" on:click={()=>signOut()} class="btn btn-outline btn-primary">Logout</button>
...
{:else}
  <button type="button" on:click={()=>signIn()} class="login btn btn-wide btn-outline btn-primary">
    Login Discord
  </button>
{/if}
